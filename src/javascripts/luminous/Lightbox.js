...
export default class Lightbox {
  ...
  _preloadImgs() {
    const previous = this.settings._gallery.previousTrigger(this.currentTrigger);
    preloadImg(previous.getAttribute(this.settings.sourceAttribute));

    const next = this.settings._gallery.nextTrigger(this.currentTrigger);
    preloadImg(next.getAttribute(this.settings.sourceAttribute));
  }
